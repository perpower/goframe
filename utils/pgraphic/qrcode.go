...
// size: int 二维码图片的尺寸
// return: []byte
func (q *gqrcode) Encdoe(content string, size int) ([]byte, error) {
...
func (q *gqrcode) Writefile(content string, size int, fileName string) error {
...
// fileName: string 文件名称
func (q *gqrcode) WriteColorFile(content string, size int, background color.Color, foreground color.Color, fileName string) error {
